  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen flex">
        {/* Main Content */}
        <div className={`${showChat ? 'w-2/3' : 'w-full'} min-h-screen`}>
          {/* Header */}
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  <div className="relative">
                    ...
                    {/* Small indicator dot for new messages */}
        ...
        {/* Chat Panel - appears alongside task list when enabled */}
        <AnimatePresence>
          {showChat && token && (
            <motion.div
              initial={{ x: '100%' }}
              ...
              className="w-1/3 border-l bg-white flex flex-col shadow-xl z-10"
            >
              ...
              <div className="flex-1 overflow-hidden p-4">
                <ChatPanel userId={userId} authToken={token} />
              </div>
            </motion.div>
          )}
        </AnimatePresence>
